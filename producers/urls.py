...
urlpatterns = [
    # basic
    path('producer/login/', views.ProducerLoginView.as_view(), name='login'),
    ...
    path('producer/content/stories/<int:story_id>/edit/', views.edit_farm_story, name='edit_farm_story'),
