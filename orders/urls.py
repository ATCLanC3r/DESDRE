...
urlpatterns = [
    ...
    path('receipt/<int:order_id>/', views.download_order_receipt, name='download_receipt'),
    ...
    path('recurring/instance/<int:pk>/checkout/', views.checkout_instance, name='recurring_checkout_instance'),
]
